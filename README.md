...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/dns_dns_lookup \
  -H 'Content-Type: application/json' \
  -d '{"domain":"example.com"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/dns_dns_lookup`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
